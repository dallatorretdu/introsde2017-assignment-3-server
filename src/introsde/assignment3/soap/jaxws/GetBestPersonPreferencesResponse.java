...
@XmlRootElement(name = "getBestPersonPreferencesResponse", namespace = "http://soap.assignment3.introsde/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getBestPersonPreferencesResponse", namespace = "http://soap.assignment3.introsde/")
