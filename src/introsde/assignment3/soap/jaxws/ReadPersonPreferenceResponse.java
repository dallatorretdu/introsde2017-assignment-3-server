...
@XmlRootElement(name = "readPersonPreferenceResponse", namespace = "http://soap.assignment3.introsde/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "readPersonPreferenceResponse", namespace = "http://soap.assignment3.introsde/")
