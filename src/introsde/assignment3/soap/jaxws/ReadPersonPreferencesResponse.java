...
@XmlRootElement(name = "readPersonPreferencesResponse", namespace = "http://soap.assignment3.introsde/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "readPersonPreferencesResponse", namespace = "http://soap.assignment3.introsde/")
